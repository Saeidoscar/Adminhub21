...
import { listReviews, createReview, type ReviewRow } from "../lib/api"
...
export default function AdminPublicProfilePage() {
  ...
  const [activeTab, setActiveTab] =
    useState<"profile" | "packages" | "custom" | "reviews">("profile")
        ...
        <>
          ...
          <div className="bg-white rounded-2xl border border-[#e2e8f0] p-6 mb-6">
            <div className="flex items-start gap-4">
              <img
                src={resolvePhotoUrl(admin.photo, { width: 120, height: 120 })}
                alt={admin.nameEn}
          ...
          <div className="flex gap-1 bg-white border border-[#e2e8f0] rounded-xl p-1 mb-6 w-fit shadow-sm">
            {[
              ...
              <button
                ...
                onClick={() =>
                  setActiveTab(
                    tab.id as "profile" | "packages" | "custom" | "reviews",
                  )
                }
