export default function MyLawyerDirectorySkeleton() {
  return (
    <div aria-busy="true" aria-live="polite">
      <span className="sr-only">در حال دریافت فهرست وکلا...</span>
      <div className="mb-8 grid animate-pulse gap-3 rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7">
      ...
      <div className="grid animate-pulse grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {Array.from({ length: 8 }, (_, index) => (
          <div
            key={index}
            className="h-64 rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-gray-900"
          >
            ...
            <div className="mt-6 h-14 rounded-xl bg-gray-100 dark:bg-gray-800/70" />
          </div>
        ))}
      </div>
    </div>
