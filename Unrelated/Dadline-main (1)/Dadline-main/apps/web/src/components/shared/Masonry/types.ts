...
type PolymorphicComponentProp<T extends ElementType,
Props = NonNullable<unknown>,> = PropsWithChildren<Props & AsProp<T>> & Omit<ComponentPropsWithoutRef<T>, PropsToOmit<T, Props>>

type PolymorphicComponentPropWithRef<T extends ElementType,
Props = NonNullable<unknown>,> = PolymorphicComponentProp<T, Props> & {
