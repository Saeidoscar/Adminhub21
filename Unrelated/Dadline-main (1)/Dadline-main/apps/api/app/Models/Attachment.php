...
class Attachment extends Model
{
    ...
    {
        return $this->hasMany(Story::class, 'featured_image_id');
    }

    public function featuredBlogs(): HasMany
    {
        return $this->hasMany(Blog::class, 'featured_image_id');
    }
    ...
    public function officeAttachments(): HasMany
    {
