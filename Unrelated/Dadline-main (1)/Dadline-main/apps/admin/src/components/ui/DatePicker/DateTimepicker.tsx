  ...
  (props, ref) => {
    ...
    const [inputState, setInputState] = useState(
      _value instanceof Date
        ? capitalize(moment(_value).locale("fa").format(dateFormat))
        : "",
    )
    ...
    useEffect(() => {
      ...
      if (value instanceof Date && !focused) {
        setInputState(moment(value).locale("fa").format(dateFormat))
      }
    ...
    const handleValueChange = (date: Date) => {
      ...
      if (!value && !closePickerOnChange) {
        setInputState(moment(date).locale("fa").format(dateFormat))
      }
      closePickerOnChange &&
        setInputState(capitalize(moment(date).locale("fa").format(dateFormat)))
    ...
    const handleTimeChange = (time: Date | null) => {
      if (_value instanceof Date && time instanceof Date) {
        ...
        if (!value && !closePickerOnChange) {
          setInputState(
            capitalize(moment(newDateTime).locale("fa").format(dateFormat)),
          )
        }
